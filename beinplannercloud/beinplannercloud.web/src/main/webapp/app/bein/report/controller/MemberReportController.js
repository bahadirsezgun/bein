ptBossApp.controller('MemberReportController', function($rootScope,$routeParams,$scope,$filter,$http,$translate,parameterService,$location,homerService,commonService,globals) {
...
var toUTCDate = function(date){
  ...
  $scope.toLocaleStr=localeStr;
	...
	$scope.getMemberPacketSale=function(userId){
		return $http({method:"POST", url:"/bein/packetsale/findUserBoughtPacketsForReport/"+userId}).then(function successCallback(response){
